...
import { ActivityIndicator, Alert,Dimensions,TouchableOpacity, FlatList, ScrollView,SafeAreaView,ImageBackground,Text, StyleSheet, View, TextInput } from 'react-native';
 ...
 import MovieDetails_Sub_Header from './MovieDetails_Sub_Header.js';
export default class MovieDetails_Sub extends Component {
static navigationOptions = ({ navigation, navigationOptions }) => {
        const { params } = navigation.state;

        return {
            title: 'MovieDetails_Sub'
...
if (this.state.orientation === 'portrait') {
 ...
 return (
      ...
      <View style={styles.MainContainer}>
        <MovieDetail_Sub_Header {...this.props}/>
